...
aside: false
---
In [Part 1](2023-10-08-containerized-openradioss_macos.md) I described how to run [OpenRadioss](https://github.com/OpenRadioss/OpenRadioss){:target="_blank" rel="noopener"} on macOS by setting up a Linux virtual machine that can build and run the arm64 Apptainer image. Now the real fun begins.
