...
Welcome back to the next installment of my series on [OpenRadioss](https://github.com/OpenRadioss/OpenRadioss){:target="_blank" rel="noopener"}! In [Part 1](2023-10-08-containerized-openradioss_macos.md) we set up a virtual machine that could build and run the arm64 Linux Apptainer image. 
[Part 2](2023-11-28-openradioss-container-directory-sharing.md) covered directory sharing settings to seamlessly transfer model files between your host <--> virtual machine <--> container file systems.
...
<img src="/assets/lsprepost/rd_config.png" style="width:75%;" />
...
<img src="/assets/lsprepost/xrdp_lspp_success.png" />
