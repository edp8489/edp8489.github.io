...
Using a 2.0 safety factor, 64/2 = 32 ksi.  
$E_c$ is constant for all operating stresses.
...
Using a 1.4 safety factor, 64/1.4 = 45.7 ksi.  
$E_t$ = 10.3 Msi for the L and ST grain directions and at the cusp of nonlinear behavior for the LT direction. 

Using a 1.25 safety factor, 64/1.25 = 51.2 ksi.  
$E_t$ = 9.25 Msi for L, 10 Msi for ST, and 10.4 Msi for LT grain directions.

<div align="center"
><img src="/assets/ir_buckling/AL7050-T7451_Et.png" alt="AL 7050-T7451 compressive tangent modulus curve (MIL-HDBK-5J)" style="width:75%;" />
</div>
