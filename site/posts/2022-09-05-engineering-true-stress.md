...
## Equations
Subscript *0* indicates original, undeformed dimension. Subscript *new* indicates instantaneous dimension under load.
...
<h4>Engineering stress</h4>

$$ \sigma_{eng} = \frac{F}{A_0} $$

<h4>Engineering strain</h4>
...
<h4>Cold work factor (and percentage)</h4>
<i>Approximately equal to, ignoring the elastic portion of deformation.</i>
...
<h3>MIL-HDBK-5J / MMPDS-01 "Inelastic Stress-Strain response"</h3>
...
<h3>Hollomon / Halford / Datsko</h3>  
An equation for modeling the <u>plastic portion</u> of the true stress / true strain diagram is referenced by Shigley (Section 2-3) and concisely summarized by the front matter of a material test report prepared for the US Department of Energy (Mulkey, pgs 13-18). It is based on a modified Ramberg-Osgood relationship and can be used to represent material behavior in the full plastic region beyond the yield stress.
